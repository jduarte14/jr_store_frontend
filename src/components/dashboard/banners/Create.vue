...
const postBanner = async (e: Event) => {
    ...
    try {
        ...
        const response = await fetchData(`https://jrstore-production.up.railway.app/api/banners`, 'POST', bannerData);
...
<template>
    <section>
        ...
        <div class="product_container">
            <form @submit="postBanner">
                ...
                <b>Banner Link</b>
                <input type="number" v-model="data.link" required />
                ...
                <div class="row">
                    ...
                    <div class="preview_image">
                        <div class="remove_icon" v-if="imageData.desktop_image.previewUrl" @click="removeImage('desktop_image')">
                ...
                <div class="row">
                    ...
                    <div class="preview_image">
                        <div class="remove_icon" v-if="imageData.mobile_image.previewUrl" @click="removeImage('mobile_image')">
                            <Icon icon="zondicons:close-solid" color="red" />
                        </div>
    ...
    <WarnPopup v-if="successPopUp" icon="success" warnTitle="Banner succesfully created"
        warnMessage="The banner has been added to the home" buttonOneText="Accept"
        :firstFunction="handleSuccessPopUp" />
    <WarnPopup v-if="rejectedPopUp" icon="error" warnTitle="Error"
        warnMessage="There was an error while creating the banner" buttonOneText="Accept"
